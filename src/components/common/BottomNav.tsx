...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 flex border-t border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 md:hidden">
      {NAV_ITEMS.map((item) => {
        ...
        return (
          <Link
            ...
            className={`flex flex-1 flex-col items-center gap-0.5 py-2 text-xs transition-colors ${
              isActive ? 'text-teal-600 dark:text-teal-400 font-semibold' : 'text-zinc-600 dark:text-zinc-400'
            }`}
          >
