  ...
  return (
    <main className="min-h-screen bg-gray-50 dark:bg-zinc-950">
      <div className="max-w-2xl mx-auto px-4 py-16 text-center">
        ...
        {/* 무료 플랜 카드 */}
        <div className="rounded-2xl border-2 border-teal-400 ring-4 ring-teal-100 dark:ring-teal-900/30 bg-white dark:bg-zinc-950 p-8 shadow-lg mb-8">
          <div className="flex items-center justify-center gap-3 mb-2">
            <span className="text-2xl font-bold text-gray-900 dark:text-zinc-100">BINAH</span>
          ...
          <p className="text-5xl font-extrabold text-gray-900 dark:text-zinc-100 my-6">
            ₩0
            <span className="text-base font-normal text-gray-500 dark:text-zinc-400">/월</span>
          </p>

          <ul className="space-y-3 text-left mb-8">
            {features.map((feature) => (
              <li key={feature} className="flex items-start gap-3 text-sm text-gray-700 dark:text-zinc-300">
                <svg
